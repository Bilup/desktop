 ...
 * Forked from scratch-gui/src/community/pages/Settings.jsx (Bilup/scratch-gui develop)
 * so the desktop settings window does not depend on whichever Settings.jsx happens
 * to ship in the installed scratch-gui (develop-builds) package.
 * All GUI-internal imports are pinned through the 'scratch-gui/src/...' module specifier.
 * Re-sync this file from the upstream file when Bilup/scratch-gui Settings.jsx changes.
 */
import React, {useState, useEffect} from 'react';
import {getItem as getStorageItem} from 'scratch-gui/src/lib/utils/safe-storage.js';
import {useIntl} from 'scratch-gui/src/lib/tw-use-intl.jsx';
...
import {
    getUsernameOverride,
    setUsernameOverride
} from 'scratch-gui/src/lib/rotur/cloud-sync.js';
import {
    getAccentMenuBar,
    setAccentMenuBar,
    getMenuBarText,
...
} from 'scratch-gui/src/lib/themes/menu-bar-accent.js';
import {getRoturSettings, updateRoturSettings} from 'scratch-gui/src/lib/rotur/settings.js';
import {presenceSupported} from 'scratch-gui/src/lib/rotur/client.js';
import isScratchDesktop from 'scratch-gui/src/lib/utils/isScratchDesktop.js';
import styles from 'scratch-gui/src/community/pages/Settings.module.css';
